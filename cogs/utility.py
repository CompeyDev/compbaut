...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name="Authors", value="`DevComp`, `Taki`, `fourjr`")
        ...
        embed.add_field(
            ...
            value="Follow the installation guide on [GitHub](https://github.com/DevComp/compbaut/) "
    ...
    async def sponsors(self, ctx):
        ...
        async with self.bot.session.get(
            "https://raw.githubusercontent.com/DevComp/compbaut/master/SPONSORS.json"
        ) as resp:
    ...
    async def update(self, ctx, *, flag: str = ""):
        ...
        desc = (
            ...
            "(https://github.com/DevComp/compbaut/blob/master/bot.py#L25)"
        )
